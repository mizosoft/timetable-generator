...
import com.github.mizosoft.timetablegenerator.old.model.Lab;
import com.github.mizosoft.timetablegenerator.old.model.Lecture.Builder;
  ...
  public CourseAttendableForm(JDialog owner, List<Teacher> teachers, List<Room> rooms) {
    ...
    typeComboBox.setModel(
        new DefaultComboBoxModel<>(
            new String[] {
              Utils.capitalizeEnum(CourseAttendable.Type.LECTURE),
              Utils.capitalizeEnum(CourseAttendable.Type.LAB)
            }));
